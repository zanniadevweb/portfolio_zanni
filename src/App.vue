<template>
  <v-app>
    ...
    <v-col class="py-0">
      <v-list-item-content>
        <v-avatar size="128" v-if="!mini">
          <img src="../public/images/photo_avatar.jpg" alt="photo_alexandre_zanni" tile>
        </v-avatar>
      </v-list-item-content>
    </v-col>
    <v-col class="py-0">
      <v-list-item color="rgba(0, 0, 0, .4)" dark>
        <v-list-item-content>
          <v-list-item-title class="text-h6">Alexandre ZANNI</v-list-item-title>
    ...
    <v-list nav dense>
      <v-list-item-group v-model="group" mandatory active-class="lime--text text--accent-4">
